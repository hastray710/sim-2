          ...
          <el-col :span="12">
            ...
            <!--为订购资费 是否 轮询断网-->
              ...
              <span slot="label">
                ...
                <el-radio-group v-model="queryParams.is_NetworkBreak">
                  <el-radio  :label="999">不操作</el-radio>
                  <el-radio  :label="0">否</el-radio>
                  <el-radio  :label="1">是</el-radio>
                </el-radio-group>
...
export default {
  ...
  methods: {
    ...
    getPwd_Str(){
      ...
      map.is_NetworkBreak = this.queryParams.is_NetworkBreak;
    ...
    submitFileForm() {
      ...
      if (tools.Is_null(this.queryParams.package_id) == true||
        ...
        this.titleUp(_this);
      }else if (this.queryParams.is_NetworkBreak=="0"){
        this.titleUp(_this);
      }else if (this.queryParams.is_NetworkBreak=="1"){
        this.titleUp(_this);
      }else{
        this.submitFileFormBtn = true;
    ...
    titleUp(_this){
      ...
      if(_this.queryParams.is_Disconnected=="0"){
        if(tools.Is_null( _this.queryParams.remind_ratio)){
          msg += ' 轮询 》设置 未订购资费 轮询停机 为【'+_this.queryParams.remind_ratio+'】MB ';
        }else{
          _this.queryParams.remind_ratio =  '';
          msg += ' 轮询 》设置 未订购资费 轮询停机  ';
        }
      }
      ...
      if (_this.queryParams.is_NetworkBreak=="0"){
        if (tools.Is_null( _this.queryParams.remind_ratio)){
      ...
      if (_this.queryParams.is_NetworkBreak=="1"){
        if (tools.Is_null( _this.queryParams.remind_ratio)){
          msg += ' 轮询 》设置 未订购资费 轮询断网 为【'+_this.queryParams.remind_ratio+'】MB ';
        }else {
          _this.queryParams.remind_ratio =  '';
