<template>
  <div class="app-container">
      ...
      <el-col :span="mainwidth" :xs="24">
          ...
          <el-row :gutter="10" class="mb8" style="margin-left: 15px;">
            ...
            <span class="el-form-item__label" style="font-weight: 700;"
              ...
              >
                <el-option
                  v-if="!internalBool"
                  v-for="dict in RouteOptions_change"
                  :key="dict.cd_id"
                  :label="dict.cd_alias"
                  :value="dict.cd_id"
                />
                <el-option
                  v-if="internalBool"
                  v-for="dict in findCr_RouteOptions_change"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
                  :value="dict.dictValue"
                />
            ...
            <el-form-item label="资费组" prop="status">
              ...
              >
                <el-option
                  v-for="dict in packageOptions_change"
                  :key="dict.package_id"
          ...
          <el-row :gutter="10">
            <el-col :span="1.5" >
              ...
              <el-input
                ...
                :placeholder="selValueplaceholder"
                clearable
                size="small"
                style="width: 350px"
                @keyup.enter.native="handleQuery"
              ...
              >
                <el-option
                  v-for="dict in card_sel_batch_type"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
                  :value="dict.dictValue"
                />
              ...
              <el-button type="primary" icon="el-icon-d-caret" style="height: 30px" size="mini" @click="switchMode"></el-button>
        ...
        <el-table v-loading="loading" :data="cardList" ref="multipleTable" @selection-change="handleSelectionChange">
          ...
          <el-table-column :label="columns[1].label" align="center" v-if="columns[1].visible" key="msisdn"
            ...
            <template slot-scope="scope">
                <span @click="ViewDetails(scope.row)" class="link-type"
                      v-hasPermi="['yunze:card:find']">{{ scope.row.msisdn }}</span>
            </template>
          </el-table-column>
          <el-table-column :label="columns[2].label" align="center" key="iccid" prop="iccid" v-if="columns[2].visible"
            ...
            <template slot-scope="scope">
                <span @click="ViewDetails(scope.row)" class="link-type"
                      v-hasPermi="['yunze:card:find']">{{ scope.row.iccid }}</span>
            </template>
          </el-table-column>
          ...
          <el-table-column :label="columns[14].label" align="center" key="due_expire_time" prop="due_expire_time" width="100"
    ...
    <el-dialog :visible.sync="show_ds" width="85%" :close-on-click-modal="false" append-to-body>
      ...
      <!--卡简要信息 子组件-->
      <cardInfoBrief ref="cardInfoBrief"  style="margin-top: 10px;"
                     :BriefEditexecute="BriefEditexecute" :show_Iccid="show_ds"  @SetObj="SetObj" :sel="sel" :showDiagnosis="showDiagnosis"
      ...
      <!-- 卡信息面板 子组件 -->
      <cardInfoDetails ref="cardInfoDetails"  style="margin-top: 10px;"
                       :DetailsEditexecute="DetailsEditexecute" :show_Iccid="show_ds"  @SetObj="SetObj" :sel="sel"
                       :access_type="access_type" :online_status="online_status" :DxCMP_RAT="DxCMP_RAT" :DxCMP_online="DxCMP_online"  :packageOptions="packageOptions"
    ...
    <el-dialog :visible.sync="show_BeRenewed" width="80%" :close-on-click-modal="false" append-to-body>
      <!--查看待续费 子组件-->
      <toBeRenewed ref="toBeRenewed"
                   :BeRenewedexecute="BeRenewedexecute" :show_BeRenewed="show_BeRenewed"  @SetObj="SetObj"
                   :toBeRenewedArr="toBeRenewedArr"  :toBeRenewedICCIDArr="toBeRenewedICCIDArr"  :toBeRenewedCount="toBeRenewedCount"
                   :packageOptions="packageOptions"  :DeptOptions="DeptOptions" :operators_type="operators_type" :stateShowId="stateShowId"
                   :customize_whether="customize_whether"
    ...
    <el-dialog :title="biange" :visible.sync="Flexible" width="500px" append-to-body>
      <el-form :model="ParamsShowId">
        <el-form-item label="灵活变更状态" prop="status" style="margin-left: 90px;">
          <el-select
            v-model="ParamsShowId.status_ShowId"
            placeholder="灵活变更状态"
            clearable
            size="small"
            style="width: 150px"
