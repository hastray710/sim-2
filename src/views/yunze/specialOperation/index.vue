<template>
  <div class="app-container">
    ...
    <el-row >
      <el-col :span="3">
        <router-link to="/specialOperation/type/selImei" >
      ...
      <el-col :span="3">
        <router-link to="/specialOperation/type/Selbatch" >
          <el-button type="primary" style="margin-left: 16px;">
            批量停复机、断开网
          </el-button>
        </router-link>
      ...
      <el-col :span="3">
        <router-link   v-hasPermi="['yunze:card:importSetCardInfo']" :to="'/specialOperation/type/cardInfoEdit'" class="link-type"  >
          <el-button  type="primary" style="margin-left: 16px;">
            变更 卡分组及备注
          </el-button>
        </router-link>
      ...
      <el-col :span="3">
        <router-link   :to="'/cardInfoSel'" class="link-type"  >
          <el-button  type="primary" style="margin-left: 16px;">
            卡简要信息查询
          </el-button>
        </router-link>
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/yunze/card/importSelImei",
        Pstr:'',//携带参数
      },
  ...
  methods: {
    ...
    submitFileForm() {
      ...
      if(files.length>0){
        tools.openAsk(this,'warning', "是否确认 imei批量查询？", this.uploadUp,this, this.FalseFun,null);
      }else{
