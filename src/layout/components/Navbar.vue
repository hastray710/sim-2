  ...
  <div class="navbar">
    ...
    <div class="right-menu">
      ...
      <template v-if="device!=='mobile'">
        ...
        <!-- <el-tooltip v-hasPermi="['yunze:batchBusiness:list']" content="批量任务" effect="dark" placement="bottom">
          <router-link  :to="'/card/batchBusiness/'" class="link-type">
            <svg-icon icon-class="druid"  class="right-menu-item hover-effect" style="width: 45px"  class-name="card-panel-icon"/>
          </router-link>
        </el-tooltip> -->
        <screenfull id="screenfull" content="全屏模式" class="right-menu-item hover-effect" />
