...
export const constantRoutes = [
  ...
  {/*** 卡信息简要信息查询 */
    path: '/cardInfoSel',
    component: (resolve) => require(['@/views/yunze/specialOperation/cardInfoSel'], resolve),
    hidden: true
  },
  {
    path: '',
...

  {
    ...
    children: [
      {
        path: 'CCommodity',
        component: (resolve) => require(['@/views/yunze/commodity/commodity/index'], resolve),
        name: 'commodity',
        meta: { title: 'C端商品管理', icon: '' }
      },
    ]
  },

  {
    ...
    children: [
      ...
      {
        path: 'batchBusiness/:TaskId(.*)',
        component: (resolve) => require(['@/views/yunze/flowcard/batchBusiness/index'], resolve),
        name: 'batchBusiness',
        meta: { title: '批量业务受理', icon: '' }
      },
      {
        path: 'cardSetting',
      ...
      {
        path: 'Channel',
        component: (resolve) => require(['@/views/yunze/API/cardRoute/index'], resolve),
        name: 'Channel',
        meta: { title: '物联卡通道', icon: '' }
      },
      {
        path: 'applicationforRenewal/:Pstr(.*)',
        component: (resolve) => require(['@/views/yunze/flowcard/applicationforRenewal/index'], resolve),
        name: 'index',
        meta: { title: '续费进度', icon: '' }
      },
    ]
  },
...

  {
    ...
    children: [
      ...
      {/*** 批量 下发短信 */
        path: 'type/smsCC',
        component: (resolve) => require(['@/views/yunze/specialOperation/smsCC'], resolve),
        name: 'smsCC',
        meta: { title: '批量下发短信' }
      }
